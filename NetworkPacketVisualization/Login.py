...
class App(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.login_label = customtkinter.CTkLabel(self.login_frame, text="Kamikaze",
        ...
        self.main_label = customtkinter.CTkLabel(self.main_frame, text="Kamikaze",
                                                 font=customtkinter.CTkFont(size=20, weight="bold"))
